...
fn pinned_preview_docs_cover_the_frozen_reference_contract() {
    ...
    for phrase in [
        ...
        "tree → active preview → pinned preview → tree",
        "Pinned: <path> — widen to view",
        "Confirming from a pinned preview moves focus to the active preview",
