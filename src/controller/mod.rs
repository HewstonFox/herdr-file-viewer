...
impl Controller {
    ...
    fn apply_re_root(&mut self, resolved: crate::root::Resolved) {
        ...
        // split_manual, wrap_override, baseline, pinned_snapshot, and preview_split_pct keep their
        // current values. The frozen pin is a root-independent reference; active/root-bound content above
        // is reset. The fresh
